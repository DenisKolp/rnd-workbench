...
milestone **0.9.7**, но не обозначает готовую Windows-поставку.
...
переносятся на две строки, компактная голосовая подсказка не перегружает экран,
а техническая диагностика пилота свёрнута по умолчанию.
