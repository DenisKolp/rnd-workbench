...
def test_speech_excerpt_never_exceeds_limit_for_long_unbroken_word() -> None:
    excerpt = SpeechExcerptBuilder(max_chars=20, max_segments=1)

    spoken = excerpt.offer("сверхдлинноесловобезпробелов")
